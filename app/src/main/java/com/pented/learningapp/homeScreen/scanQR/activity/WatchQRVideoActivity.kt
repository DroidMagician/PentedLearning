...
import kotlinx.android.synthetic.main.activity_watch_scanned_video.*
import kotlinx.android.synthetic.main.activity_watch_scanned_video.bottomLayout
import kotlinx.android.synthetic.main.activity_watch_scanned_video.mainFrame
import kotlinx.android.synthetic.main.activity_watch_scanned_video.playerView
import kotlinx.android.synthetic.main.activity_watch_scanned_video.progressBarPlayer
import kotlinx.android.synthetic.main.activity_watch_scanned_video.progressView1
import kotlinx.android.synthetic.main.activity_watch_scanned_video.txtPoints
import kotlinx.android.synthetic.main.activity_watch_scanned_video.txtTopicName
import kotlinx.android.synthetic.main.activity_watch_scanned_video.youTubePlayerView
...
//                        }
    ...
    private fun init() {
        ...
        if(intent.hasExtra("topicVideo"))
        {
            ...
            txtPoints.text = "${yourObject.data?.Points} Points"
            topicId = yourObject.data?.TopicId ?: 0
            Log.e("yourObject","Is Here ${Gson().toJson(yourObject)}")
            txtTopicName.text = yourObject.data.TopicVideoTitle
